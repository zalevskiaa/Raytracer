...
function(add_shad_executable NAME)
  ...
  get_filename_component(TASK_NAME ${CMAKE_CURRENT_SOURCE_DIR} NAME)
  if (TEST_SOLUTION)
    prepend(SHAD_LIBRARY_SOLUTION_SRCS "../tests/${TASK_NAME}" ${SHAD_LIBRARY_SOLUTION_SRCS})
  endif()

  if (ENABLE_PRIVATE_TESTS)
    prepend(SHAD_LIBRARY_PRIVATE_TESTS "../tests/${TASK_NAME}" ${SHAD_LIBRARY_PRIVATE_TESTS})
  endif()
